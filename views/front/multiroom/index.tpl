...
{block "content"}
    <div class="multiroom-rooms">
        {foreach $rooms as $room}
            <div class="multiroom-room js-room-{$room.channels} js-room" data-id="{$room.channels}" data-playlist="{$room.playlist.PlaylistId}">
                <div class="head">
                ...
                <div class="detail">
                    ...
                    <div class="tracker js-tracker">
                        <div class="full js-track" style="width: {{$room.playlist.Position/$room.playlist.Duration*100}}%"></div>
                    ...
                    <div class="controls">
                        <a href="#" class="{if $room.playlist.IsPlaying}pause js-pause{else}play js-play-playlist{/if} "></a>
